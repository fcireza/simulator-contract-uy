...
export default function FamilySurchargeDetail({
  familyDetail,
  darkMode,
}: FamilySurchargeDetailProps) {
  const {
    hasSpouse,
    childrenCount,
    ...
    <div className="ml-5 py-2 space-y-1 border-l-2 border-gray-300 dark:border-gray-600 pl-3">
      ...
      {(disabledChildrenCount ?? 0) > 0 && (
        ...
        >
          ...
          <span className="text-red-400">
            +{formatUyu(disabledChildDeduction ?? 0)}
          </span>
        </div>
      )}
    </div>
