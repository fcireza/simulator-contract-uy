    ...
    <div className={`max-w-5xl mx-auto ${textClass}`}>
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg max-w-2xl mx-auto">
          ...
          <span className={`font-semibold ${accentClass}`}>contractors IT en Uruguay</span>{' '}
          que ayuda a calcular el ingreso neto después de impuestos.
        </p>
      </div>
      ...
      <div className={`p-8 rounded-xl ${cardClass} mb-8`}>
        ...
        <p className="mb-4">
          ...
          en Uruguay que trabajan como independientes (contractors) para empresas del exterior.
        </p>
        <p>
          La mayoría de las herramientas de cálculo fiscal están diseñadas para empleados
          en relación de dependencia. Este proyecto busca{' '}
          <span className="font-medium">llenar ese vacío</span> y facilitar la toma de
          decisiones informadas sobre el régimen impositivo más conveniente.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
        {features.map((feature) => (
          ...
          >
            <div className={`mb-3 ${accentClass}`}>
              {feature.icon}
            </div>
            <h3 className={`text-base font-semibold mb-2 ${headingClass}`}>
              {feature.title}
            </h3>
            <p className="text-sm">
              {feature.description}
      ...
      <div className={`p-6 rounded-xl border-l-4 border-yellow-500 ${darkMode ? 'bg-yellow-900/20' : 'bg-yellow-50'}`}>
        ...
        <p className="text-sm">
          ...
          el asesoramiento fiscal profesional. Los cálculos son aproximados (precisión estimada ±10%)
          y pueden variar según tu situación particular.
        </p>
        <p className="text-sm mt-2">
          Para decisiones fiscales importantes, <span className="font-medium">siempre consultar con un
            contador habilitado</span> por el Colegio de Contadores del Uruguay.
        </p>
      </div>
      <br />
      <hr />
